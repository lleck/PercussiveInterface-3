...
void TMAG5170::begin(uint8_t chipSelectPin){
  ...
  //SPI.begin(CLOCK_PIN, MISO_PIN, MOSI_PIN, chipSelectPin);
    Serial.println("hanswurstdietpetr");
...
void TMAG5170::default_cfg ( bool *error_detected )
{
    ...
    write_frame(TMAG5170_REG_DEVICE_CONFIG, TMAG5170_CONV_AVG_32X | 
                                                                            TMAG5170_MAG_TEMPCO_0 | 
                                                                            TMAG5170_OPERATING_MODE_DUTY_CYCLED | 
                                                                            TMAG5170_T_CH_EN_ENABLE | 
                                                                            TMAG5170_T_RATE_PER_CONV_AVG | 
                                                                            TMAG5170_T_HLT_EN_DISABLE, &error); 
    
    
                                    // TMAG5170_CONV_AVG_1X |               // additional sampling to reduce noise
                                    //  TMAG5170_MAG_TEMPCO_0p12 |                  // temp. coefficient of target magnet in %/C°
                                    //  TMAG5170_OPERATING_MODE_DUTY_CYCLED |           // active trigger mode enabled 
    ...
    write_frame(TMAG5170_REG_SENSOR_CONFIG, TMAG5170_ANGLE_EN_XY_ANGLE | 
                                                                            TMAG5170_SLEEPTIME_100MS | 
                                                                            TMAG5170_MAG_CH_EN_ENABLE_XYZ | 
                                                                            TMAG5170_Z_RANGE_25mT | 
                                                                            TMAG5170_Y_RANGE_25mT | 
                                                                            TMAG5170_X_RANGE_25mT, &error);
    
                                    // TMAG5170_ANGLE_EN_NO_ANGLE |         // no angle calculation (default)
    ...
    write_frame(TMAG5170_REG_SYSTEM_CONFIG,  TMAG5170_DIAG_SEL_ALL_DP_DIAG_ALL | 
                                                                            TMAG5170_TRIGGER_MODE_SPI_CMD | 
                                                                            TMAG5170_DATA_TYPE_32BIT_REG | 
                                                                            TMAG5170_DIAG_EN_DISABLE |
                                                                            TMAG5170_Z_HLT_EN_DISABLE |
                                                                            TMAG5170_Y_HLT_EN_DISABLE |
                                                                            TMAG5170_X_HLT_EN_DISABLE, &error );
    
                                    // TMAG5170_DIAG_SEL_ALL_DP_DIAG_ALL |  // diagnostic mode on all data paths (default)
    ...
    write_frame(TMAG5170_REG_ALERT_CONFIG, TMAG5170_ALERT_LATCH_DISABLE | 
                                                                           TMAG5170_ALERT_MODE_INTERRUPT | 
                                                                           TMAG5170_STATUS_ALRT_AFE_SYS_NO_ASSERT | 
                                                                           TMAG5170_RSLT_ALRT_CONV_COMPLETE | 
                                                                           TMAG5170_THRX_COUNT_1_CONV | 
                                                                           TMAG5170_T_THRX_ALRT_NO_CROSSED |
                                                                           TMAG5170_Z_THRX_ALRT_NO_CROSSED |
                                                                           TMAG5170_Y_THRX_ALRT_NO_CROSSED |
                                                                           TMAG5170_X_THRX_ALRT_NO_CROSSED, &error );
    
                                    // TMAG5170_ALERT_LATCH_DISABLE, &error);// alert source latching state (irrelevant if alert pin nc)

    write_frame(TMAG5170_REG_MAG_GAIN_CONFIG, TMAG5170_GAIN_SELECTION_NO_AXIS, &error );

                                    // TMAG5170_GAIN_SELECTION_NO_AXIS, &error);
